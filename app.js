(function(){
  ...
  app.controller('Customer', function($scope, $http) {
    ...
    $scope.addCustomer=function(){
      ...
      $http({
        method  : 'POST',
        url     : "http://www.baniyekidukaan.in/bkd/backend/index.php/user/add_user",
        ...
        if(response.data.status==true){
          bootbox.confirm("Customer Added Successfully !", function(result){
            window.location.href = 'http://www.baniyekidukaan.in/bkd/feedback.html';
           });
        }
        else {
  ...
  app.controller('Feedback', function($scope, $http) {
    ...
    $http({
      method  : 'POST',
      url     : "http://www.baniyekidukaan.in/bkd/backend/index.php/user/is_user_loggedin",
      data    : $scope.data, //forms user object
      headers : {'Content-Type': 'application/x-www-form-urlencoded'}
    }).then(function mySucces(response) {
      //  console.log(JSON.stringify(response));
      ...
      bootbox.confirm("Need to add Customer First!", function(result){
        window.location.href = 'http://www.baniyekidukaan.in/bkd/customer.html';
       });
      }
    ...
    $scope.addFeedback=function(){
      ...
      $http({
        method  : 'POST',
        url     : "http://www.baniyekidukaan.in/bkd/backend/index.php/user/add_user_feedback",
        data    : $scope.data, //forms user object
        headers : {'Content-Type': 'application/x-www-form-urlencoded'}
      }).then(function mySucces(response) {
        //  console.log(JSON.stringify(response));
        if(response.data.status==true){
          ...
          bootbox.confirm("Feedback Submited!", function(result){
            window.location.href = 'http://www.baniyekidukaan.in/bkd/Survey.html';
           });
        }
        else {
          bootbox.alert(response.data.msg);
  ...
  app.controller('Survey', function($scope, $http) {
    ...
    $scope.addSurvey=function(){
      ...
      $http({
        method  : 'POST',
        url     : "http://www.baniyekidukaan.in/bkd/backend/index.php/user/add_survey",
        data    : $scope.data, //forms user object
        headers : {'Content-Type': 'application/x-www-form-urlencoded'}
      }).then(function mySucces(response) {
        if(response.data.status==true){
  ...
  $scope.addProduct=function(){
    ...
    $http({
      method  : 'POST',
      url     : "http://www.baniyekidukaan.in/bkd/backend/index.php/product/add_product",
      data    : $scope.data, //forms user object
      headers : {'Content-Type': 'application/x-www-form-urlencoded'}
    }).then(function mySucces(response) {
      if(response.data.status==true){
  ...
  $scope.getProduct=function(){
    ...
    $http({
      method  : 'POST',
      url     : "http://www.baniyekidukaan.in/bkd/backend/index.php/product/get_product_details/"+$scope.productId,
      data    : $scope.data, //forms user object
      headers : {'Content-Type': 'application/x-www-form-urlencoded'}
    }).then(function mySucces(response) {
      if(response.data.status==true){
  ...
  $scope.editProduct=function(){
    ...
    $http({
      method  : 'POST',
      url     : "http://www.baniyekidukaan.in/bkd/backend/index.php/product/edit_product",
      data    : $scope.data, //forms user object
      headers : {'Content-Type': 'application/x-www-form-urlencoded'}
    }).then(function mySucces(response) {
      if(response.data.status==true){
  ...
  $scope.editCategory=function(){
    ...
    $http({
      method  : 'POST',
      url     : "http://www.baniyekidukaan.in/bkd/backend/index.php/category/edit_category",
      data    : $scope.data, //forms user object
      headers : {'Content-Type': 'application/x-www-form-urlencoded'}
    }).then(function mySucces(response) {
      if(response.data.status==true){
